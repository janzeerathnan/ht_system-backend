...
import { updateHoliday } from '../api';

const EditHolidayForm = ({ isOpen, onClose, holiday, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        const response = await updateHoliday(holiday.HolidayID, {
        ...
        showSnackbar('Failed to update holiday. Please try again.', 'error');
      } finally {
        setLoading(false);
      }
    }
